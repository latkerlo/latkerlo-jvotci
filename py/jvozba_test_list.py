...
JVOZBA_ONLY_TESTS = [
    ["latkerlo", ["mlatu", "kerlo"]],
    ["latkerlo", "mlatu  kerlo"],  # 2 spaces
    ["latkerlo", "mlatu　kerlo"],  # ideographic space U+3000
...
JVOZBA_FAIL_TESTS = [
    [2, TypeError],
    ["", IndexError],
    ["弱音ハク", NonLojbanCharacterError],
    ["弱音 ハク", NonLojbanCharacterError],
    ["弱音　ハク", NonLojbanCharacterError],
    ["mla2 kerlo", NonLojbanCharacterError],
    ["mlatu k3rlo", NonLojbanCharacterError],
    ["mi", IndexError],
    ["mlatu", IndexError],
    ["kerlo mi", NoLujvoFoundError],
    ["kerlo mi'e", NoLujvoFoundError],
    ["mi'e kerlo", NoLujvoFoundError],
    ["mutce gbatu", InvalidClusterError],
    ["gbatu mutce", InvalidClusterError],
    ["tarti -jno-", InvalidClusterError],
    ["lat kerlo", NoLujvoFoundError],
    ["palci latkerlo", NoLujvoFoundError],
    ["jaurgacmi'imle", NoLujvoFoundError],
    ["jaurgacmi'imle kerlo", NoLujvoFoundError],
    ["-kerlo- kerlo", NoLujvoFoundError],
    ["-123- kerlo", NonLojbanCharacterError],
    ["-k1r- kerlo", NonLojbanCharacterError],
    ["-弱音- -ハク-", NonLojbanCharacterError],
    ["-弱音- -ハku-", NonLojbanCharacterError],
    ["-弱音- -haku-", NonLojbanCharacterError],
    ["mlatu -弱音-", NonLojbanCharacterError],
    ["mlatu -ハク-", NonLojbanCharacterError],
    ["mlatu -ハku-", NonLojbanCharacterError],
    ["mlatu -haku-", NonLojbanCharacterError],
    ["-弱音- kerlo", NonLojbanCharacterError],
    ["-ハク- kerlo", NonLojbanCharacterError],
    ["-ハku- kerlo", NonLojbanCharacterError],
    ["-haku- kerlo", NonLojbanCharacterError],
    ["mlatu -kelo-", InvalidClusterError],
    ["-matu- kerlo", InvalidClusterError],
    ["kerlo -kerlo- kerlo", NoLujvoFoundError],
    ["-kerlolo- kerlo", InvalidClusterError],
    ["kerlo xi", NoLujvoFoundError],
    ["tu'a kerlo", NoLujvoFoundError],
]
...
JVOKAhA_FAIL_TESTS = [
    ["", IndexError],
    ["弱音ハク", DecompositionError],
    ["mlatu", IndexError],
    ["latk3rlo", DecompositionError],
    ["latrkerlo", DecompositionError],
    ["latnkerlo", InvalidClusterError],  # TODO: decomp vs. invalid cluster has to do with program structure more than word itself
    ["tosmabru", DecompositionError],
    ["fu'irvla", DecompositionError],
    ["selbazti", InvalidClusterError],
    ["dindji", DecompositionError],
    ["samynlatu", InvalidClusterError],
    ["branlatu", InvalidClusterError],
    ["tcegbatu", InvalidClusterError],
    ["gbatytce", InvalidClusterError],
    ["co'unre'", DecompositionError],
    ["co'ure'", DecompositionError],
    ["co'ure'e", DecompositionError],
    ["lonumico'e", (DecompositionError, InvalidClusterError)],
    ["trajno", InvalidClusterError],

    ["lamzac", InvalidClusterError],
    ["miscac", InvalidClusterError],
    ["miszac", InvalidClusterError],
    ["tolmiszac", InvalidClusterError],
    ["nontsap", DecompositionError],
    ["veimi'ikeicinfra'asam", DecompositionError],

    ["akti", (DecompositionError, InvalidClusterError)],
    ["na'akti", (DecompositionError, InvalidClusterError)],
    ["aktigau", (DecompositionError, InvalidClusterError)],
    ["na'aktigau", (DecompositionError, InvalidClusterError)],
    ["atkerlo", (DecompositionError, InvalidClusterError)],
    ["valslinku'i", (DecompositionError, InvalidClusterError)],
    ["va'islinku'i", (DecompositionError, InvalidClusterError)],
    ["slinkuui", (DecompositionError, InvalidClusterError)],
    ["spageti", (DecompositionError, InvalidClusterError)],
    ["cidjrspageti", (DecompositionError, InvalidClusterError)],
    ["djarspageti", (DecompositionError, InvalidClusterError)],
    ["uinmo", (DecompositionError, InvalidClusterError)],
    ["uirnainmo", (DecompositionError, InvalidClusterError)],
    ["ge'enmo", (DecompositionError, InvalidClusterError)],

    # fu'ivla lujvo tests
    ["barduku'ykei", DecompositionError],
    ["miby'ismu", DecompositionError],
    ["mibyiismu", DecompositionError],
    ["iismynei", DecompositionError],
    ["norycrezuue", DecompositionError],
    ["zganyiicne", DecompositionError],
    ["zgazga'yiicne", DecompositionError],
    ["zgafai'yiicne", DecompositionError],
    ["bapyiicne", DecompositionError],
    ["bapyiicne", DecompositionError],
    ["fatryiicne", DecompositionError],
    ["fatry'aicne", DecompositionError],

    ["mlatu'ykerlo", DecompositionError],
]

LUJVO_SCORE_TESTS = [
    ["mlatu kerlo", 7937, 5898],
    ["lorxu kerlo", 7937, 5898],
    ["vacri te jabre", 10886, 9877],
    ["sevzi lacri", 7937, 5898],
    ["dukse ke sevzi lacri", 13835, 11796],
    ["tanbo skami", 9506, 6387],
    ["tanbo skami dukse", 10925, 9336],
    ["crino djedi", 6367, 7397],
    ["sanmi bukpu", 7456, 5867],
    ["co'u trene", 7976, 6387],
    ["co'u trene sazri", 12475, 9336],
    ["tcana jatna", 8497, 9038],
    ["tcana tcana tcana", 15086, 14077],
    ["kosta mabru", 9037, 5898],
    ["kosta kosta mabru", 11986, 8847],
]
